                        ...
                        <div className="border-0 rounded-md shadow-lg  relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className="relative p-5">
                                ...
                                <p className="text-right text-slate-700 font-medium">
                                    LINKS: <br/>
                                    <a href="https://github.com/pixelRena/Travel-Dreams" target="_blank"><DiGithubFull size="2.8em" className="mr-2 border-b-2 border-neutral-500 inline cursor-pointer" title="View Code"/></a>
                                    <a href="https://pixelrena.github.io/Travel-Dreams/" target="_blank"><BsBoxArrowInRight size="1.8em" className="text-sky-500 inline cursor-pointer" title="View Website"/></a>
                                </p>
                            </div>
                        </div>
                    </div>
