export default function Home() {
    return(
        <div className="text-white grid place-items-center h-screen">
                <div className="absolute text-9xl top-0 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-10 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-20 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-32 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-44 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-56 mt-8 lg:mt-0">.</div>
                <div className="absolute text-9xl top-72 mt-8 lg:mt-0">.</div>
