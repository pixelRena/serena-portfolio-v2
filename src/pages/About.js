...
export default function About() {
	return(
		...
		<div className="text-white h-[32rem] grid lg:grid-cols-3 lg:mt-0 lg:h-screen lg:p-32 lg:gap-4 lg:content-center">
			<div className="col-span-2 mt-32 w-48 h-48 rounded-full border-8 border-neutral-800 shadow-2xl shadow-black justify-self-center lg:w-96 lg:h-96 lg:col-span-1">
