	...
	return(
		<div className="text-white mt-32 h-[32rem] grid lg:grid-cols-3 lg:mt-0 lg:h-screen lg:p-32 lg:gap-4 lg:content-center">
			...
			<div className="col-span-2 mt-5">
				<h1 className="text-2xl font-semibold lg:text-6xl">Serena Dean</h1>
				...
				<div className="flex flex-col justify-center items-center lg:flex-row">
					<button className="mr-2 border-2 border-white rounded-lg font-semibold p-2 hover:bg-white hover:text-black text-sm mt-2 lg:mt-0 lg:inline lg:p-3 lg:text-lg">Get in touch</button>
					<button className="mr-2 border-2 border-white rounded-lg font-semibold p-2 hover:bg-white hover:text-black text-sm mt-2 lg:mt-0 lg:inline lg:p-3 lg:text-lg">Discover my work</button>
				</div>
			</div>
		</div>
	);
