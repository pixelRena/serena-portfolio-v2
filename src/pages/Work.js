	...
	return(
		...
		<div className="fade m-auto w-11/12 h-[62rem] lg:h-screen lg:w-10/12 lg:mt-16">
			<div className="text-white flex flex-wrap h-screen justify-center items-center gap-5 lg:gap-20">
				...
				<div>
					<div className="relative mb-5 bg-neutral-900 p-20 bg-cover bg-scroll bg-no-repeat overflow-hidden bg-center border-4 rounded-md shadow-lg shadow-black lg:p-40 lg:border-8" style={{backgroundImage: "url('/images/rtflogo.png')"}}>
					...
					<div className="relative bg-neutral-900 p-20 bg-cover bg-no-repeat bg-center overflow-hidden border-4 rounded-md shadow-lg shadow-black lg:p-40 lg:border-8" style={{backgroundImage: "url('images/beachcover.png')"}}>
						<video className="absolute object-cover h-96 bottom-0 left-0 hover:bg-black hover:bg-opacity-40 ease-in duration-300" src="/videos/mixkit-top-aerial-shot-of-seashore-with-rocks-1090-large.mp4" onMouseOver={(e) => e.target.play()} onMouseOut={(e) =>e.target.pause()} ></video>
